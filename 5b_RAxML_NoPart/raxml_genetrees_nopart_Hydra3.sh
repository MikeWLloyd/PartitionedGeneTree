...
for ARQ in $workdir/*_OUT/*.phylip-relaxed
	...
	qsub -pe orte 8 -q sThC.q -l mres=1.7G,h_data=1.7G,h_vmem=1.7G -N gtree_$locus -S /bin/sh -e ./logs/$locus.job.err -o ./logs/$locus.job.out -cwd -m aes raxml_job_part_Hydra3.job $ARQ
